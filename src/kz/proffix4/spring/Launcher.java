...
class Launcher {
    ...
    public static void main(String[] args) {
        try {
            ...
            AnimalDAO animalDAO = (AnimalDAO) context.getBean("AnimalDAO"); // Загрузка бина доступа к таблице клиентов 
            ...
            animalDAO.insert(new Animal("Bella", "cat", 10));
            ...
            animalDAO.deleteByAnimalKind("br");      // Удаление записей по фрагменту вида
            ...
            animalDAO.deleteByNickName("Bella"); // Удаление по кличке
